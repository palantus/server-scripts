...
/usr/local/bin/aws s3 cp "/home/ahk/backup/server2_complete_$6-$2-$3.tar.gz" s3://dk.ahkpro.backup.webserver
/usr/local/bin/aws s3 sync /var/www/owncloud/data s3://dk.ahkpro.backup.owncloud
